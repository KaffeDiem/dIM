...
public class CryptoController {
    public enum CryptoHandlerError: Error, LocalizedError {
    ...
    public static func fetchPublicKeyString() -> String {
    ...
    public static func fetchPrivateKey() throws -> P256.KeyAgreement.PrivateKey {
    ...
    public static func convertPrivateKeyToString(_ privateKey: P256.KeyAgreement.PrivateKey) -> String {
    ...
    public static func convertPublicKeyToString(_ publicKey: P256.KeyAgreement.PublicKey) -> String {
    ...
    public static func convertPrivateKeyStringToKey(_ privateKey: String) throws -> P256.KeyAgreement.PrivateKey {
    ...
    public static func convertPublicKeyStringToKey(_ publicKey: String?) throws -> P256.KeyAgreement.PublicKey {
    ...
    public static func deriveSymmetricKey(privateKey: P256.KeyAgreement.PrivateKey, publicKey: P256.KeyAgreement.PublicKey) throws -> SymmetricKey {
    ...
    public static func encryptMessage(text: String, symmetricKey: SymmetricKey) throws -> String {
    ...
    public static func decryptMessage(text: String, symmetricKey: SymmetricKey) -> String {
        do {
